...
incorrect_lamda = lambda p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14=42: p1 # Noncompliant {{Usage of excess number of Parameters in the function}}
#                        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
def incorrect_function(
    p1, p2, p3, p4, p5, p6,  # Noncompliant {{Usage of excess number of Parameters in the function}}
#   ^[el=+3;ec=17]
    p7, p8, p9, p10, p11,
    p12, p13, p14):
	...
...
class MyClass:
	...
	@staticmethod
	def incorrect_static_method(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14):  # Noncompliant {{Usage of excess number of Parameters in the function}}
#	                            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	  ...

	def incorrect_method(self, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14): # Noncompliant {{Usage of excess number of Parameters in the function}}
		...
...
class SomeBase():
  def incorrect_method(
      self, p1, p2, p3, p4, p5, p6,  # Noncompliant {{Usage of excess number of Parameters in the function}}
      p7, p8, p9, p10, p11,
      p12, p13, p14):
  	...
